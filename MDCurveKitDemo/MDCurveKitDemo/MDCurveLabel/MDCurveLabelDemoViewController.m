...
- (void)viewDidLoad {
    [super viewDidLoad];
    _label = [[MDCurveDemoLabel alloc] initWithFrame:CGRectMake(0, 0.f, 320, self.view.frame.size.height - 88.f - 88.f)];
    _label.center = CGPointMake(self.view.frame.size.width / 2.f, self.view.frame.size.height / 2.f);
...
- (void)addSettingButtons {
    ...
    slider.center = CGPointMake(self.view.frame.size.width / 2.f, self.view.frame.size.height - 66.f);
